...
export const testGraphQLProperty = (fields, property, type, obj = null, expectedResolve = null, args = null, ctx = null) => {	
	return function() {
		...
		if(!(obj === null && expectedResolve === null)) {
			if(typeof expectedResolve === "boolean") {
				expect(fields[property].resolve(obj, args, ctx)).to.be[expectedResolve ? "true" : "false"];
			} else {
				expect(fields[property].resolve(obj, args, ctx)).to.deep.equals(expectedResolve);
			}
		}
	}
}
